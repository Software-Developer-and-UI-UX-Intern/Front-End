...
import bali from '../../../assets/hotel/ntb/up.png';
  ...
  return (
    <Stack sx={{
      ...
      <Stack sx={{
        ...
        <Stack>
        <Typography fontSize={'82px'} fontFamily={'TelkomselBatikBold'} color={'#FFF'}>Selamat datang di Nusa Tenggara Barat!</Typography>
      ...
      <Stack sx={{
        ...
        <Stack sx={{
          ...
          <Stack direction={'row'} gap={3} marginLeft={'100px'} marginRight={'100px'}>
            ...
            <ListHotel selectedStars={selectedStars} minimal={value} maximal={value2} checkedFasilitas={checkedFasilitas} selectedDomisili={'ntb'} />
            </Stack>
          </Stack>
