...
export default function RestoranPage() {
  ...
  <Stack sx={{ backgroundColor: '#04214C' }} flexDirection={'column'} margin={'0 20px 0 20px'} width={'calc((372px * 8) + 100px)'} height={'auto'} border={'2px solid #04214C'} borderRadius={'30px 30px 0 0'}>
